...
export class OcopContentDto {
  ...
  @ApiProperty({ enum: OCOP_CATEGORIES })
  @IsIn(OCOP_CATEGORIES)
  category: OcopCategoryLabel;

  @ApiProperty({ enum: OCOP_RATINGS })
  @IsIn(OCOP_RATINGS)
  ...
  @ApiProperty({
    maxLength: 30,
    description:
      'Số điện thoại liên hệ đặt mua. Chỉ chữ số, khoảng trắng và tối đa một dấu + ở đầu',
...
export class CreateOcopProductDto extends OcopContentDto {
...
export class UpdateOcopProductDto extends OcopContentDto {
