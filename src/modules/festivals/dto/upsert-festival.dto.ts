...
export class FestivalContentDto {
  ...
  @ApiProperty({ enum: FESTIVAL_CATEGORIES })
...
export class CreateFestivalDto extends FestivalContentDto {
...
export class UpdateFestivalDto extends FestivalContentDto {
